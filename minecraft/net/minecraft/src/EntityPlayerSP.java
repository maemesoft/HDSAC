...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        {
            this.skinUrl = SkinUtils.getSkin(StringUtils.stripControlCodes(par3Session.username));
        }
    ...
    {
        this.playerCloakUrl = SkinUtils.getCloak(StringUtils.stripControlCodes(this.username));
